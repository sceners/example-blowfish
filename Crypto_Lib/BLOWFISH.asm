...
Blowfish_Encrypt proc uses ecx ebx esi edi ptrOut:dword, ptrIn:dword
		pushad
...
Blowfish_Decrypt proc uses ecx ebx esi edi ptrOut:dword, ptrIn:dword
		pushad
